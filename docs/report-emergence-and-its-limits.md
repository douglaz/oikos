...
built on — and share bread **substitutes one-for-one for commons draws** up to immediate need, so
consumption is re-sourced rather than raised. Labor demand on this base is *episodic by construction*:
